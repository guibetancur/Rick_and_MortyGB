...
export default function validate (inputs) {
   ...
   else if (!regexUsername.test(inputs.username)) errors.username = 'The username must be a valid email address.'
   else if (!inputs.password) errors.password = 'You must type a password.'
